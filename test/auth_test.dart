...
void main() {
  group('Mock Authentication', () {
    ...
    test('Creat user should delegate to login function',
      () async {
        final badEmail = provider.createUser(email: "foo@bar.com", password: 'password') ;
        expect(badEmail, throwsA(const TypeMatcher<EmailAlreadyInUseAuthException>()));
        final badPassword = provider.createUser(email: "email", password: "foobar");
    ...
    test('Should be able to log out and login again',
      () async {
